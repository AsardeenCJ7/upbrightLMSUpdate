...
<head>
  ...
  <style>
    ...
    h3 {
      ...
      text-shadow: 0px 0px 10px #30c465;
      color: #30c465;
  ...
  border-bottom: 3px solid #ccc; */
    ...
    .row.header {
      ...
      background: rgb(48, 196, 101);
      background: linear-gradient(90deg,
          rgba(48, 196, 101, 0.6979166666666667) 0%,
          rgba(48, 196, 101, 1) 100%);
      color: #fff;
    }
...
<body>
  <div class="container text-center">
    ...
    <p class="mt-3 paraP">Get latest updates about the new release</p>
    <div class="mt-3">
      <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="100.001px" height="70px" viewBox="0 0 100 68">
		...
		c-6.244-2.999-8.872-10.493-5.867-16.736c3.002-6.244,10.495-8.873,16.736-5.869C42.676,28.698,45.306,36.19,42.302,42.435z" fill="none" stroke="#30c465" />
		...
		C84.573,16.331,86.05,20.549,84.365,24.062z" fill="none" stroke="#30c465" />
      ...
      <form action="<?php echo site_url('Underconst/notify'); ?>" method="post">
  <ul>
    <li>
      <p class="left">
    ...
    <li>
      ...
      <p class="pull-right">
        <label for="pnum">Phone Number: <span class="req">*</span></label>
        <input type="text" name="pnum" placeholder="Mobile Number" required/>
      </p>
    </li>

    <li>
      <p>
        <label for="current_emp">Current Employment: <span class="req">*</span></label>
        <input type="text" name="current_emp" placeholder="Current Employment" required/>
      </p>
      <p class="pull-right">
        <label for="qualification">Educational Qualification: <span class="req">*</span></label>
    ...
    <li>
      <button style="--clr:#30c465" type="submit"><span>Notify us</span><i></i></button>
    </li>
  </ul>
</form>
