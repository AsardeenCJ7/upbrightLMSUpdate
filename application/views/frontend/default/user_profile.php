            ...
            <div class="col">
                <div class="user-dashboard-box">
                    <div class="user-dashboard-sidebar">
                        ...
                        <!--User Dashboard Add some student basic details-->
                        <div class="user-box">
                            ...
                            <div class="content-box">
                                <div class="basic-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="dob" name="dob" placeholder="<?php echo site_phrase('Date of Birth'); ?>" value="<?php echo $user_details['dob']; ?>">
                                    </div>

                                    <div class="form-group">
                                        <label for="address">Address:</label>

                                        <textarea class="form-control author-biography-editor" name="address" id="Biography"><?php echo $user_details['address']; ?></textarea>


                                    </div>

                                    <!-- <div class="form-group" id="certishow">
                                        <input type="text" class="form-control" name="" placeholder="<?php echo site_phrase('certificate_name'); ?>" value="<?php echo $user_details['certificate_name']; ?>" disabled>
                                    </div> -->
