...
.container, .container-fluid, .container-sm, .container-md, .container-xl, .container-xxl {
    width: 100%;
...
.col-lg-3.col-md-6:not(#d-flex) a {
    position: relative;
    transition: letter-spacing 0.3s ease; /* Add transition to letter-spacing */
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3" style="margin-right: 15px;"></i>136 Main Cross Road, 30400, Valaichenai, SriLanaka</p>
                    <div class="d-flex" id="d-flex" style="padding-bottom: 10px;">
                        <a class="btn btn-outline-light btn-social" href=""><i class="fab fa-whatsapp"></i></a>
                        <a class="btn btn-outline-light btn-social" href="https://www.instagram.com/upbright.lk/"><i class="fab fa-instagram"></i></a>
                        <a class="btn btn-outline-light btn-social" href="https://www.facebook.com/upbright.lk"><i class="fab fa-facebook-f"></i></a>
                        <a class="btn btn-outline-light btn-social" href="https://www.youtube.com/c/upbright"><i class="fab fa-youtube"></i></a>
                    ...
                    <div class="position-relative mx-auto" style="max-width: 400px;">
                        <button type="button" class="btn btn-primary position-absolute top-0" style="width: 100%;margin-top: 10px;">Apply Frachsies</button>
                    </div>
                </div>
            </div>
        </div>
