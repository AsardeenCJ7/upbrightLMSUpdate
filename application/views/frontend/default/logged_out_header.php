        ...
        <div class="row">
            <div class="col">
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    ...
                    <a href="http://www.upbright.lk" class="navbar-brand"><img src="<?php echo base_url('uploads/system/' . get_frontend_settings('dark_logo')); ?>" alt="" height="40"></a>
                    ...
                    <div class="sign-in-box btn-group">
                        ...
                        <a href="https://upbright.lk/about" class="btn btn-sign-in gen" style="background:transparent;"><?php echo site_phrase('About'); ?></a>
                        <a href="https://shop.upbright.lk/blog" class="btn btn-sign-in gen" style="background:transparent;"><?php echo site_phrase('Blog'); ?></a>
                        <a href="https://upbright.lk/contact" class="btn btn-sign-in gen" style="background:transparent;"><?php echo site_phrase('Contact'); ?></a>
