...
@media (max-width: 768px) {
    .category-section {
        display: none !important; /* Hide the .category-section on mobile */
    }
...
<div class="tab-nav bg-transparent" style="background:#fff;">
        <ul>
            <li class="tab-nav__cta cta">
                <a href="https://lms.upbright.lk/" title="Live online courses" class="nav-item nav-link" style="border: 1px solid #30C46A;">
                    <img src="https://www.upbright.lk/images/icon/book.svg" class="imgStyleIcon">
                    <span class="hide-on-mobile" style="padding-left:5px;">Online &amp; Earning Courses</span><span class="hide-on-web">Courses</span>
                </a>
            </li>
            <li class="tab-nav__cta cta">
                <a title="Softwares" href="https://www.upbright.lk/softwares" class="nav-item nav-link" style="border: 1px solid #30C46A;">
                    <img src="https://www.upbright.lk/images/icon/software.svg" class="imgStyleIcon">
                    <span class="hide-on-mobile" style="padding-left:5px;">Premium Softwares</span> <span class="hide-on-web">Softwares</span>
                </a>
            </li>
            <li class="tab-nav__cta cta">
                <a title="Doller Exchange" href="https://www.upbright.lk/exchange" class="nav-item nav-link" style="border: 1px solid #30C46A;">
                    <img src="https://www.upbright.lk/images/icon/money.svg" class="imgStyleIcon">
                    <span class="hide-on-mobile" style="padding-left:5px;">Dollar Exchange</span> <span class="hide-on-web">Exchange</span>
                </a>
            </li>
        </ul>
    </div>
