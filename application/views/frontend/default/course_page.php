            ...
            <div class="col-lg-8">
              ...
              ?>
                    ...
                    <div class="created-row">
                        ...
                        <span
                            class="last-updated-date"><?php echo site_phrase('last_updated') . ' ' . date('D, d-M-Y', $course_details['last_modified']); ?></span>
                        <?php else : ?>
                        <span
                            class="last-updated-date"><?php echo site_phrase('last_updated') . ' ' . date('D, d-M-Y', $course_details['date_added']); ?></span>
                        <?php endif; ?>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8" style="padding:10px;">
                <h3 class="title float-left">Profit With <?php echo $course_details['title']; ?> Course
            ...
            <div class="col-lg-8" style="padding:10px">
                <div class="progress" style="height:1rem;">
                    <div class="progress-bar" role="progressbar"
                        style="width: <?php echo $course_details['course_percentage'];?>%; background:#30c465 !important;"
                        aria-valuenow="<?php echo $course_details['course_percentage']; ?>" aria-valuemin="0"
                        aria-valuemax="100">
                        <?php echo $course_details['course_percentage'];?>%
                    </div>
                </div>
            </div>
        </div>
...
<section class="course-content-area">
    <div class="container">
        <div class="row">
            <div class="col-lg-8 course-section-1">
                    ...
                    <div class="course-curriculum-accordion">
                        ...
                        <div class="lecture-group-wrapper">
                            <div class="lecture-group-title clearfix" data-toggle="collapse"
                                data-target="#collapse<?php echo $section['id']; ?>" aria-expanded="<?php if ($counter == 0) echo 'true';
                                    else echo 'false'; ?>">
                            ...
                            <div class="about-instructor-image">
                                ...
                                <ul>
                                    ...
                                    <li><i class="fas fa-comment"></i><b>
                                            <?php echo $this->crud_model->get_instructor_wise_course_ratings($instructor['id'], 'course')->num_rows(); ?>
                                        </b> <?php echo site_phrase('reviews'); ?></li>
                                    <li><i class="fas fa-user"></i><b>
                                            <?php
                                                    $course_ids = $this->crud_model->get_instructor_wise_courses($instructor['id'], 'simple_array');
                                    ...
                                    <li><i class="fas fa-play-circle"></i><b>
                                            <?php echo $this->crud_model->get_instructor_wise_courses($instructor['id'])->num_rows(); ?>
                        ...
                        <div class="col-lg-8">
                            <div class="about-instructor-details view-more-parent">
                                <div class="view-more" onclick="viewMore(this)">+
                                    <?php echo site_phrase('view_more'); ?></div>
                                <div class="instructor-name">
                                    <a
                                        href="<?php echo site_url('home/instructor_page/' . $instructor['id']); ?>"><?php echo $instructor['first_name'] . ' ' . $instructor['last_name']; ?></a>
                                </div>
                                <div class="instructor-title">
                                    <?php echo $instructor['title']; ?>
                                </div>
            ...
            <div class="col-lg-4 course-section-2">
                    ...
                    <div class="course-sidebar-text-box">
                        ...
                        <div class="buy-btns">
                            <a href="javascript::" class="btn btn-buy-now"
                                ...
                                onclick="handleBuyNow(this)"><?php echo site_phrase('buy_now'); ?></a>
                            <?php if (in_array($course_details['id'], $this->session->userdata('cart_items'))) : ?>
                            <button class="btn btn-add-cart addedToCart" type="button"
                            ...
                            <ul>
                                ...
                                <li>
                                    <p class="text-left text-secondary d-inline-block course-compare"
                                        ...
                                        redirect_to="<?php echo site_url('home/compare?course-1=' . rawurlencode(slugify($course_details['title'])) . '&&course-id-1=' . $course_details['id']); ?>">
                                        <i class="fas fa-balance-scale"></i>
                                        <?php echo site_phrase('compare_this_course_with_other'); ?>
                                    </p>
                                </li>
                            </ul>
                        </div>
...
<script>
// Set the date and time you want the countdown timer to end
var countDownDate = new Date("<?php echo $course_details['closing_date']; ?>");
