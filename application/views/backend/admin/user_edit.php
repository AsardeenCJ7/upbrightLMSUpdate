...
<!--Edit certificate name-->
                                        ...
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="last_name"><?php echo get_phrase('certificate_printed_name'); ?> <span class="required">*</span> </label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" id="last_name" name="certificate_name" value="<?php echo $user_data['certificate_name']; ?>" required>
                                            </div>
                                        </div>
