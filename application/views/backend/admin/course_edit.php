                        ...
                        <form class="required-form"
                            ...
                            <div id="basicwizard">
                                <ul class="nav nav-pills nav-justified form-wizard-header">
                                    ...
                                    <li class="nav-item">
                                        <a href="#course_analytics" onclick="load_analytics_chart()" data-toggle="tab"
                                            class="nav-link rounded-0 pt-2 pb-2">
                                            <i class="mdi mdi-chart-bar"></i>
                                            <span
                                                class="d-none d-sm-inline"><?php echo get_phrase('analytics'); ?></span>
                                        </a>
                                    </li>
                                    <?php endif; ?>
                                    ...
                                    <li class="nav-item">
                                        <a href="#requirements" data-toggle="tab" class="nav-link rounded-0 pt-2 pb-2">
                                            ...
                                            <span
                                                class="d-none d-sm-inline"><?php echo get_phrase('requirements'); ?></span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#outcomes" data-toggle="tab" class="nav-link rounded-0 pt-2 pb-2">
                                            ...
                                            <span
                                                class="d-none d-sm-inline"><?php echo get_phrase('outcomes'); ?></span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <div class="tab-pane" id="basic">
                                        <div class="row justify-content-center">
                                            <div class="col-xl-8">
                                                ...
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-2 col-form-label"
                                                        for="existing_instructors"><?php echo get_phrase('instructor_of_this_course'); ?></label>
                                                    <div class="col-md-10">
                                                        ...
                                                        <div class="m-2">
                                                            ...
                                                            <a href="javascript:void(0)"
                                                                onclick="confirm_modal('<?php echo site_url('admin/remove_an_instructor/' . $course_details['id'] . '/' . $instructor_details['id']); ?>');"
                                                ...
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-2 col-form-label"
                                                        for="new_instructor"><?php echo get_phrase('add_new_instructor'); ?></label>
                                                    <div class="col-md-10">
                                                        <select class="select2 form-control select2-multiple"
                                                            data-toggle="select2" multiple="multiple"
                                                            data-placeholder="Choose ..." name="new_instructors[]">
                                                            <?php $instructors = $this->user_model->get_instructor()->result_array(); ?>
                                                            <?php foreach ($instructors as $key => $instructor) : ?>
                                                            <option
                                                                value="<?php echo html_escape($instructor['id']); ?>">
                                                                <?php echo html_escape($instructor['first_name'] . ' ' . $instructor['last_name']); ?>
                                                                ( <?php echo html_escape($instructor['email']); ?> )
                                                            </option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-2 col-form-label"
                                                        for="closing_date"><?php echo get_phrase('closing_Date'); ?></label>
                                                    <div class="col-md-10">
                                                        <!-- Check if closing_date is set, and format it for the datetime-local input -->
                                                        <input type="datetime-local" class="form-control"
                                                            id="closing_date" name="closing_date"
                                                            value="<?php echo isset($course_details['closing_date']) ? date('Y-m-d\TH:i', strtotime($course_details['closing_date'])) : ''; ?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-2 col-form-label"
                                                        for="description"><?php echo get_phrase('course_percentage'); ?></label>
                                                    <div class="col-md-10">
                                                        <input type="number" class="form-control" id="course_title"
                                                            name="course_percentage"
                                                            value="<?php echo $course_details['course_percentage']; ?>">
                                                    </div>
                                                </div>

                                                <div class="form-group row mb-3">
                                                    <label class="col-md-2 col-form-label"
                                                        for="select_month"><?php echo get_phrase('Select Month'); ?></label>
                                                    <div class="col-md-10">
                                                        <select class="form-control" id="select_month"
                                                            name="select_month" required>
                                                            <option value="0"
                                                                <?php echo empty($course_details['select_month']) ? 'selected' : ''; ?>>
                                                                Select Month</option>
                                                            <option value="January"
                                                                <?php echo ($course_details['select_month'] == 'January') ? 'selected' : ''; ?>>
                                                                January</option>
                                                            <option value="February"
                                                                <?php echo ($course_details['select_month'] == 'February') ? 'selected' : ''; ?>>
                                                                February</option>
                                                            <option value="March"
                                                                <?php echo ($course_details['select_month'] == 'March') ? 'selected' : ''; ?>>
                                                                March</option>
                                                            <option value="April"
                                                                <?php echo ($course_details['select_month'] == 'April') ? 'selected' : ''; ?>>
                                                                April</option>
                                                            <option value="May"
                                                                <?php echo ($course_details['select_month'] == 'May') ? 'selected' : ''; ?>>
                                                                May</option>
                                                            <option value="June"
                                                                <?php echo ($course_details['select_month'] == 'June') ? 'selected' : ''; ?>>
                                                                June</option>
                                                            <option value="July"
                                                                <?php echo ($course_details['select_month'] == 'July') ? 'selected' : ''; ?>>
                                                                July</option>
                                                            <option value="August"
                                                                <?php echo ($course_details['select_month'] == 'August') ? 'selected' : ''; ?>>
                                                                August</option>
                                                            <option value="September"
                                                                <?php echo ($course_details['select_month'] == 'September') ? 'selected' : ''; ?>>
                                                                September</option>
                                                            <option value="October"
                                                                <?php echo ($course_details['select_month'] == 'October') ? 'selected' : ''; ?>>
                                                                October</option>
                                                            <option value="November"
                                                                <?php echo ($course_details['select_month'] == 'November') ? 'selected' : ''; ?>>
                                                                November</option>
                                                            <option value="December"
                                                                <?php echo ($course_details['select_month'] == 'December') ? 'selected' : ''; ?>>
                                                                December</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-2 col-form-label"
                                                        for="description"><?php echo get_phrase('year_of_batch'); ?></label>
                                                    <div class="col-md-10">
                                                        <input type="number" class="form-control" id="course_title"
                                                            name="select_year"
                                                            value="<?php echo $course_details['select_year']; ?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-2 col-form-label"
                                                        for="course_status"><?php echo get_phrase('Select_course_status'); ?></label>
                                                    <div class="col-md-10">
                                                        <select class="form-control" id="select_month"
                                                            name="course_status" required>
                                                            <option value="active"
                                                                <?php echo empty($course_details['course_status']) ? 'active' : ''; ?>>
                                                                Active</option>
                                                            <option value="deactive"
                                                                <?php echo ($course_details['course_status'] == 'deactive') ? 'selected' : ''; ?>>
                                                                Deactive</option>
                                                        </select>
                                                    </div>
                                                </div>
